        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <button
              ...
              className="w-full flex justify-center py-3 px-4 rounded-lg text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading
                ? isSignIn
                  ? "Signing in..."
