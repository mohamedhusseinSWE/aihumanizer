            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Word Limit / Request</TableHead>
                  <TableHead>Words / Month</TableHead>
                ...
                {plans.length === 0 ? (
                  ...
                  paginatedPlans.map((plan) => (
                    <TableRow key={plan.id}>
                      ...
                      <TableCell>{plan.wordLimitPerRequest}</TableCell>
                      <TableCell>{plan.wordsPerMonth}</TableCell>
                      <TableCell>
                        <Badge
                          className={
                            plan.status === "ACTIVE"
