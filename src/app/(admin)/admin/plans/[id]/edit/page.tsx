...
export default function EditPlanPage() {
  ...
  useEffect(() => {
    if (existingPlan) {
      setForm({
        ...
        wordLimitPerRequest: existingPlan.wordLimitPerRequest || 0,
        wordsPerMonth: existingPlan.wordsPerMonth || 0,
  ...
  const availableModels = ["ChatGPT", "Claude", "StealthGPT"];
      ...
      <div className="max-w-5xl mx-auto">
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            {/* Words per Month */}
            <div className="space-y-2">
              <Label>Words per Month (0 = unlimited)</Label>
              <Input
                type="number"
                name="wordsPerMonth"
